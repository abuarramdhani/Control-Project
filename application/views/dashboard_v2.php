                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead>
                                    <tr >
                                        <th style="background-color: SandyBrown; color: white">IMO</th>
                                        <th style="background-color: SandyBrown; color: white">IMO (back)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="delDashboard2/<?php echo $p->IMO_v2; ?>"><button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>  Delete All </button></a>
                                        </td>
                                    </tr>  
                                    <?php } ?>
