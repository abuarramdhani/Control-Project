                        ...
                        <div class="table-responsive-sm">
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                        <a href="editOP/<?php echo $key->IMO; ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button></a>
                                        </td>
                                        ...
                                        <td><a href="delDashboard/<?php echo $key->IMO; ?>"><button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>  Delete All </button></a></td>
