...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header"><center>Plug Paid Amount Details </center></h1>
                    ...
                    <?php
                        ...
                        echo "<br> <br>";
                            ...
                            ?>
                                ...
                                <p id="value" ></p>
                                <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/simpandetPlugPaid"; ?>">
