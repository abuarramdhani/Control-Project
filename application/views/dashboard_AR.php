                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th></th>
                                        <th>No. Plug</th>
                                        <th>Invoice Plug Date</th>
                                        <th>Invoice Plug Amount</th>
                                        <th></th>
                                        <th>Plug Payment Date</th>
                                        <th>Plug Paid Amount</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $k->inv_date ?></td>
                                        <td><?php echo $k->pay_inv ?></td>
                                        <td><a href="detCust/<?php echo $k->IMO; ?>">details</a></td> 
                                        <td><?php echo $k->inv_pay_date ?></td>
                                        <td><?php echo $k->pay_inv_paid ?></td>
                                        <td><a href="detCustPaid/<?php echo $k->IMO; ?>">details</a></td>
                                        <td><?php echo $k->no_plug ?></td>
                                        <td><?php echo $k->inv_plug_date ?></td>
                                        <td><?php echo $k->pay_plug ?></td>
                                        <td><a href="detPlug/<?php echo $k->IMO; ?>">details</a></td>
                                        <td><?php echo $k->plug_pay_date ?></td>
                                        <td><?php echo $k->pay_plug_paid ?></td>
                                        <td><a href="detPlugPaid/<?php echo $k->IMO; ?>">details</a></td>
                                        <td>
