                                ...
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/insertAR"; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="inv_pay_date">
                                        </div>
                                        <div class="form-group">
                                            <label>No. Plug</label>
                                            <input class="form-control" placeholder="Enter No. Plug" name="no_plug">
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice Plug Date</label>
                                            <input class="form-control" type="date" name="inv_plug_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Plug Payment Date</label>
                                            <input class="form-control" type="date" name="plug_pay_date">
                                        </div>
