                                    ...
                                    <form role="form" method="post" action="<?php echo base_url()."index.php/pagecontrol/insertAP"; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required name="name_ag" required>
                                                ...
                                                <?php foreach ($nameAgen as $name) { ?>
                                                <option><?php echo $name->name_agen ?></option>
                                                <?php } ?>
                                            </select>  
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_ag_date">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_genset_date">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required name="name_ship" required>
                                                ...
                                                <?php foreach ($nameShip as $ship) { ?>
                                                <option><?php echo $ship->name_ship ?></option>
                                                <?php } ?>
                                            </select>  
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_ship_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Ship</label>
                                            <input type="date" class="form-control" name="date_ship">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_thc_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date THC</label>
                                            <input type="date" class="form-control" name="date_thc">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Invoice Handling Date</label>
                                            <input type="date" class="form-control" name="inv_handl_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Handling</label>
                                            <input type="date" class="form-control" name="date_handl">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_plug_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Plug</label>
                                            <input type="date" class="form-control" name="date_plug">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inv_lain_date">
                                        </div>
                                        <div class="form-group">
                                            <label>Payment Date Lain</label>
                                            <input type="date" class="form-control" name="date_lain">
                                        </div>
